      ...
      <div className="max-w-7xl mx-auto px-6 md:px-12">
        ...
        <div className="max-w-3xl mx-auto text-center mb-16 md:mb-24">
          <div className="mb-6">
            <div className="overflow-hidden">
              ...
              >
                <span className="block text-3xl md:text-4xl lg:text-5xl font-display font-semibold text-[#1a1a1a] tracking-tight">
            ...
            <div className="overflow-hidden">
              <div
                ...
                className="translate-y-[110%]"
              >
                <span className="block text-3xl md:text-4xl lg:text-5xl font-serif italic font-normal text-[#c9a86c]">
          ...
          <p
            ref={textRef}
            className="text-base md:text-lg text-[#4a4a4a] font-sans leading-relaxed opacity-0"
          >
        ...
        >
          {introGridConfig.portfolioImages.map((image, index) => (
            ...
            >
              <img
                src={image.src.replace('.jpg', '-640w.webp')}
                srcSet={`${image.src.replace('.jpg', '-320w.webp')} 320w, ${image.src.replace('.jpg', '-640w.webp')} 640w, ${image.src.replace('.jpg', '-960w.webp')} 960w`}
              ...
              <div className="absolute top-4 left-4 w-8 h-8 border-t-2 border-l-2 border-[#c9a86c]/0 group-hover:border-[#c9a86c]/80 transition-all duration-500" />
              <div className="absolute top-4 right-4 w-8 h-8 border-t-2 border-r-2 border-[#c9a86c]/0 group-hover:border-[#c9a86c]/80 transition-all duration-500" />
              <div className="absolute bottom-4 left-4 w-8 h-8 border-b-2 border-l-2 border-[#c9a86c]/0 group-hover:border-[#c9a86c]/80 transition-all duration-500" />
              <div className="absolute bottom-4 right-4 w-8 h-8 border-b-2 border-r-2 border-[#c9a86c]/0 group-hover:border-[#c9a86c]/80 transition-all duration-500" />
            </div>
          ))}
        </div>
        ...
        {introGridConfig.accentText && (
          <div className="mt-12 md:mt-16 flex justify-end">
            <p className="text-sm text-[#c9a86c] font-sans tracking-wider uppercase">
              {introGridConfig.accentText}
            </p>
          </div>
        )}
